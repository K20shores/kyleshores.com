  ...
  return (
    <div className={styles.socialList}>
      <ul>
        ...
        <li>
            <a href={`https://www.github.com/${social?.github}`} target="_blank" rel="noreferrer">
            <svg>
        ...
        <li>
            <a href={`https://www.orcid.org/${social?.orcid}`} target="_blank" rel="noreferrer">
            <svg>
                <use xlinkHref="#icon-orcid"/>
            </svg>
            </a>
        </li>
        <li>
            <a href={`https://scholar.google.com/citations?user=${social?.googlescholar}`} target="_blank" rel="noreferrer">
            <svg>
                <use xlinkHref="#icon-google-scholar"/>
            </svg>
            </a>
        </li>
      </ul>
      <svg aria-hidden="true" style={
        ...
        <defs>
          ...
          <symbol id="icon-google-scholar" viewBox="0 0 24 32">
