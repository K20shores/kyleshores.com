...
import { StyledSVG, StyledSocialList, StyledSocialLi } from './social.styled';

const Linkedin = () => (
  <StyledSVG>
    <svg aria-hidden="true" 
      version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink"
      data-generator="https://icomoon.io/app/">
...
const Publons = () => (
  <StyledSVG>
    <svg aria-hidden="true" 
      version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink"
      data-generator="https://icomoon.io/app/">
        <path d="M17.629 7.686c-0.201-0.491-0.49-0.942-0.812-1.361-0.768-0.97-1.783-1.793-2.992-2.125-1.818-0.503-3.833-0.026-5.316 1.115-0.319 0.242-0.601 0.524-0.863 0.825-0.125-0.649-0.164-1.313-0.311-1.957-0.075-0.081-0.148-0.202-0.278-0.182-0.322 0.006-0.622 0.142-0.915 0.262-1.264 0.55-2.524 1.108-3.787 1.657-0.133 0.064-0.3 0.096-0.385 0.229-0.028 0.178-0.026 0.362-0.002 0.541 0.077 0.175 0.267 0.255 0.422 0.35 0.407 0.229 0.847 0.417 1.204 0.726 0.321 0.264 0.491 0.671 0.52 1.079 0.013 0.135 0.017 0.271 0.018 0.408-0.001 4.961 0.001 9.923-0.001 14.884-0.032 0.627 0.009 1.259-0.092 1.881-0.052 0.293-0.22 0.62-0.54 0.678-0.479 0.037-0.963-0.018-1.441 0.025-0.128 0.005-0.173 0.144-0.165 0.251 0.001 0.285-0.008 0.571 0.005 0.857-0.001 0.078 0.085 0.116 0.128 0.169 0.894-0.023 1.788-0.088 2.682-0.099 1.709-0.033 3.42-0.003 5.126 0.1 0.134 0.001 0.345 0.002 0.375-0.167 0.027-0.305 0.023-0.614 0.002-0.919-0.002-0.135-0.14-0.2-0.258-0.2-0.369-0.019-0.739-0.002-1.108-0.006-0.215-0.006-0.448 0.026-0.644-0.083-0.195-0.119-0.263-0.356-0.316-0.564-0.156-0.779-0.098-1.579-0.127-2.368-0.019-1.754-0.046-3.509-0.052-5.264 0.726 0.327 1.515 0.498 2.306 0.567 1.374 0.132 2.79-0.14 4.002-0.805 1.527-0.82 2.699-2.219 3.361-3.81 0.524-1.247 0.755-2.608 0.732-3.957-0.005-0.93-0.116-1.875-0.479-2.738zM14.288 14.931c-0.272 0.97-0.824 1.929-1.737 2.418-0.771 0.429-1.696 0.377-2.533 0.211-0.65-0.128-1.239-0.462-1.736-0.892-0.425-0.416-0.584-1.033-0.575-1.613 0.008-2.526-0.012-5.053 0.010-7.578 0.57-0.799 1.496-1.316 2.463-1.449 0.918-0.135 1.888 0.167 2.549 0.821 0.895 0.873 1.338 2.096 1.597 3.293 0.31 1.573 0.396 3.229-0.036 4.788z"></path>
    </svg>
  </StyledSVG>
)
