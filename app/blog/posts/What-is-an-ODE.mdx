...
tags: [ODE-series]
image: "assets/img/pexels/math.jpg"
---

import EstimatePi from "../../components/blog/WhatIsAnODE/EstimatePi";
import AFunction from "../../components/blog/WhatIsAnODE/AFunction";
import TheFunction from "../../components/blog/WhatIsAnODE/TheFunction";
import Formalism from "../../components/blog/WhatIsAnODE/Formalism";
import Footnotes from "../../components/mdx";
import FootnoteReference from "../../components/mdx";
...
a dad asking his kids to tell him how to make a sandwich](https://www.reddit.com/r/ProgrammerHumor/comments/fioap6/dad_teaching_kids_basic_coding_principles_by/). Specificity is hard.
...
presented as fact, and interpreted by fallible humans. And yet the world works. Bridges and buildings don't often randomly collapse, 3-day weather forecasts provide reasonably accurate and useful information, you can
...
provided by algorithms and the _maths_ that underlie them provide enough
determinism to allow complex systems to be stable and, more importantly, _useful_.

# I Don't Know What I'm Doing

In my day-job, I have almost no idea what I'm fundamentally doing in
...
To better understand the math behind my job I am going to read two books and try to relay what I learn from them,

here <FootnoteReference id="hairer1993" />, <FootnoteReference id="hairer1996" />.
...
<Footnotes citations={[{ id: "hairer1993" }, { id: "hairer1996" }]} />
