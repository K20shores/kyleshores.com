...
To better understand the math behind my job I am going to read two books and try to relay what I learn from them, here <FootnoteReference id="1" />, <FootnoteReference id="2" />.
