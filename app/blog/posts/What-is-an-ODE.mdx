...
import Footnote, { CitationsList } from '../../components/mdx';
...
To better understand the math behind my job I am going to read two books and try to relay what I learn from them, here <Footnote id="hairer1993" />, <Footnote id="hairer1996" />.
...
[^1]: <Citation id="hairer1993" />
[^2]: <Citation id="hairer1996" />